...
# ── 系統初始化 ──────────────────────────────────────────────────────────────
source("config/tagpilot/packages.R")    # 載入套件管理
source("config/tagpilot/config.R")      # 載入配置設定（包含 .env 載入）
...
# Shared 模組
source("modules/shared/module_wo_b.R")       # 主要分析模組 (shared)
source("modules/shared/module_dna.R")        # DNA 分析模組 (shared)
...
# TagPilot 專用模組
source("modules/tagpilot/module_upload.R")     # 上傳模組
source("modules/tagpilot/module_dna_multi_premium.R")  # DNA 分析模組 Premium with IPT T-Series Insight
