...
#####
#P07_D04_03
# DERIVATION: AMZ R120 Metadata Enrichment
# VERSION: 3.0
# PLATFORM: amz
# GROUP: D04
# SEQUENCE: 03
# PURPOSE: Enrich Poisson analysis tables with R120 metadata
# CONSUMES: processed_data.duckdb/df_amz_poisson_analysis_{product}
# PRODUCES: processed_data.duckdb/df_amz_poisson_analysis_{product} (enriched)
# PRINCIPLE: DM_R044, MP064, MP029, R120
#####

#amz_D04_03

#' @title AMZ DRV - R120 Metadata Enrichment
...
#' @input_tables processed_data.duckdb/df_amz_poisson_analysis_{product}
#' @output_tables processed_data.duckdb/df_amz_poisson_analysis_{product}
...
tryCatch({
  message("════════════════════════════════════════════════════════════════════")
  message("AMZ DRV - R120 Metadata Enrichment")
  message("════════════════════════════════════════════════════════════════════")
  ...
  if ("df_amz_sales_complete_time_series" %in% dbListTables(con_app)) {
    source_ts <- tbl2(con_app, "df_amz_sales_complete_time_series") %>% collect()
    if (nrow(source_ts) == 0) {
...
message("════════════════════════════════════════════════════════════════════")
message(sprintf("Script:           %s", "amz_D04_03.R"))
