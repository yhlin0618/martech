...
message("  1. Original version: 29_company_examples/mamba/02_db_utils/fn_ensure_tunnel.R")
message("  2. Enhanced version: 29_company_examples/mamba/02_db_utils/fn_ensure_tunnel_enhanced.R")
...
test_tunnel_creation <- function() {
  ...
  source("scripts/global_scripts/29_company_examples/mamba/02_db_utils/fn_ensure_tunnel_enhanced.R")
...
message("Use the enhanced version: 29_company_examples/mamba/02_db_utils/fn_ensure_tunnel_enhanced.R")
