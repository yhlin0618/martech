...
validation_config <- list(
  ...
  schema_registry_path = here::here("scripts", "global_scripts", "00_principles",
                                   ...
                                   "CH10_database_specifications", "etl_schemas"),
  templates_path = here::here("scripts", "global_scripts", "00_principles",
                             "docs", "en", "part2_implementations",
                             "CH18_templates_examples", "ETL_templates_separated")
)
...
validate_template_quality <- function() {
  ...
  quality_checks <- list(
    ...
    has_mp102_compliance = c("MP102", "platform_id", "import_timestamp"),
...
validate_principle_consistency <- function() {
  ...
  principle_files <- c(
    "docs/en/part1_principles/CH00_fundamental_principles/04_data_management/MP064_etl_derivation_separation.qmd",
    "docs/en/part1_principles/CH00_fundamental_principles/04_data_management/MP102_etl_output_standardization.qmd", 
    "docs/en/part1_principles/CH00_fundamental_principles/04_data_management/MP104_etl_data_flow_separation.qmd",
    "docs/en/part1_principles/CH02_data_management/rules/DM_R028_etl_data_type_separation.qmd",
    "docs/en/part1_principles/CH02_data_management/rules/DM_R027_etl_schema_validation.qmd"
  )
  ...
  for (principle_file in principle_files) {
    ...
    if (!file.exists(full_path)) {
      ...
      consistency_checks <- list(
        ...
        has_platform_ids = grepl("cbz|eby|amz", content_text),
