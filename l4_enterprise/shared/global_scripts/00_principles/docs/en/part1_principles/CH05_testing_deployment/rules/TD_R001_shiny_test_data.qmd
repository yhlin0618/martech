...
customer_test_block <- function(n_customers = 10, 
  ...
  return(list(
    df_profile_by_customer = customers,
    ...
    metadata = list(
      ...
      key_relationship = "df_profile_by_customer is complete, df_dna_by_customer is partial"
    )
  ))
}
```
...
test_that("microCustomer module renders correctly", {
  ...
  expected_name <- test_data$df_profile_by_customer$buyer_name[2]
...
test_module <- function(module_server_fn, test_data, input_values) {
  testServer(
    module_server_fn,
    args = list(
      df_profile_by_customer = test_data$df_profile_by_customer,
...
# Use validation once
if (!validate_data(test_data$df_profile_by_customer, 
