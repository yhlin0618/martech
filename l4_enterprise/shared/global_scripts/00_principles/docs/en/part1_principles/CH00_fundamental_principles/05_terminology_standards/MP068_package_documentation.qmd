...
subtitle: "External R packages should be documented in a dedicated directory structure that provides standardized usage patterns, common configurations, API guides, and integration examples"
author: "Claude"
date: "2025-04-10"
date-modified: "2025-08-16"
categories: [meta-principle, documentation, package-management, standards]
format:
  html:
    toc: true
    toc-depth: 3
...
### 1. Centralized Package Documentation {#centralized-documentation}
...
### 3. Package Integration Guidelines {#integration-guidelines}
...
### 4. Package-Specific Components {#package-components}
...
### 5. Custom Wrappers and Extensions {#custom-wrappers}
...
### Example Package Documentation Structure {#example-structure}
