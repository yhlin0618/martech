        ...
        fluidRow(
          bs4Card(
            ...
            div(
              ...
              img(src = "images/icon.png", width = "320px", alt = "Vital Signs Logo")
            ),
            ...
            div(
              ...
              tags$ul(
                ...
                tags$li(bs_icon("bullseye"), " 客群分群建模（Segmentation Modeling）", style = "margin-bottom: 0.8rem; font-size: 1.1rem;"),
