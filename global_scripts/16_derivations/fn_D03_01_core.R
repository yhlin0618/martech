...
# Following: MP064, MP029, MP140, DM_R025
# =============================================================================
...
run_D03_01 <- function(platform_id, config = NULL) {
  ...
  tryCatch({
    ...
    # Write to app_data
    DBI::dbWriteTable(app_data, "df_geo_sales_by_country", df_geo, overwrite = TRUE)
    ...
    DBI::dbWriteTable(app_data, "df_customer_country_map", df_ccm, overwrite = TRUE)
    ...
    DBI::dbWriteTable(app_data, "df_geo_sales_by_state", df_state, overwrite = TRUE)
