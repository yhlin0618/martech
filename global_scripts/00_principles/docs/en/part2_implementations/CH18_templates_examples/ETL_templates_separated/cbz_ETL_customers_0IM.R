...
main_execution <- function() {
  tryCatch({
    ...
    customers_processed <- process_customers_import(customers_raw_data, platform_id = "cbz")
    ...
    validation_result <- validate_customers_import(customers_standardized, platform_id = "cbz")
