...
main_execution <- function() {
  tryCatch({
    ...
    sales_processed <- process_sales_import(sales_raw_data, platform_id = "{platform}")
    ...
    validation_result <- validate_sales_import(sales_standardized, platform_id = "{platform}")
