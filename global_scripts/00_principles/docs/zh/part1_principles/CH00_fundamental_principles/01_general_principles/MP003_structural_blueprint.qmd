---
title: "MP002: Structural Blueprint"
subtitle: "Meta-Principle: Authoritative System Architecture Definition"
author: "Claude"
date: "2025-04-02"
date-modified: "2025-08-16"
categories: [meta-principle, architecture, structure, blueprint]
tags: [MP002, structure, architecture, hierarchy, organization]
format:
  html:
    toc: true
    code-fold: true
    code-summary: "Show code examples"
---
...
#### Company Information Directory Structure

The `27_company_info` directory provides a centralized location for company-specific content and branding assets that can be included in applications via `includeMarkdown()`:

```
27_company_info/
├── README.md                     # Directory usage documentation
├── template/                     # Template structure for new companies
│   ├── about.md                 # Company description template
│   ├── contacts.md              # Contact information template
│   ├── services.md              # Service offerings template
│   ├── testimonials.md          # Client testimonials template
│   └── branding/                # Branding assets template
│       ├── logo.png             
│       └── style_guide.md      
├── company_name_1/               # Example company directory
│   ├── about.md                 # Company overview and history
│   ├── contacts.md              # Contact details and locations
│   ├── services.md              # Products and services offered
│   ├── testimonials.md          # Client feedback and case studies
│   ├── team.md                  # Team members and expertise
│   ├── values.md                # Company values and mission
│   └── branding/                # Company-specific branding
│       ├── logos/               # Logo variations
│       ├── colors.yaml          # Brand color definitions
│       └── fonts.yaml           # Typography specifications
└── shared/                       # Shared across multiple companies
...
- **Company Information**: 27_company_info
...
- **ID**: MP0002
- **Type**: meta-principle
- **Derives From**: MP0000 (Axiomatization System), MP0001 (Primitive Terms and Definitions)
- **Influences**: P03 (Project Principles), P04 (Script Separation), P07 (App Construction Principles), R01 (Directory Structure Rules), R02 (File Naming Convention Rules), R03 (Principle Documentation)