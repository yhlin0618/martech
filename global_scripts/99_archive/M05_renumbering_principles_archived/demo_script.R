#' Demonstration of M05_renumbering_principles module
#'
#' This script demonstrates the functionality of the M05_renumbering_principles module.
...
result <- M05_renumbering_principles$renumber("P16", "P07", "app_bottom_up_construction")
print(result)
cat("\n")
...
result <- M05_renumbering_principles$batch_renumber(mapping_table)
print(result)
cat("\n")
