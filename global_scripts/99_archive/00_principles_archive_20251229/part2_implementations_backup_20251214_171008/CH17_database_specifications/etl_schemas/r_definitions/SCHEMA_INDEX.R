...
SCHEMA_CATALOG <- list(
  ...
  customer_data = list(
    ...
    tables = c("df_customer_profile", "df_dna_by_customer"),
...
load_all_schemas <- function(base_path = NULL) {
  if (is.null(base_path)) {
    base_path <- "scripts/global_scripts/00_principles/natural/en/part2_implementations/CH17_database_specifications/etl_schemas/r_definitions"
  }
...
#    - Ensure df_customer_profile is populated before df_dna_by_customer
#
