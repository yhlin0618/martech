...
generate_test_data <- function() {
  ...
  return(list(
    scenarios = list(
      ...
      partial = list(
        df_customer_profile = customer_data$df_customer_profile[1:10, ],
        df_dna_by_customer = customer_data$df_dna_by_customer[1:5, ]
      ),
      empty = list(
        df_customer_profile = customer_data$df_customer_profile[0, ],
...
create_test_connection <- function(scenario_data, connection_type = "list") {
  switch(connection_type,
    "list" = scenario_data,
    "function" = list(
      get_df_customer_profile = function() scenario_data$df_customer_profile,
      get_df_dna_by_customer = function() scenario_data$df_dna_by_customer
    ),
    "reactive" = list(
      df_customer_profile = reactive(scenario_data$df_customer_profile),
