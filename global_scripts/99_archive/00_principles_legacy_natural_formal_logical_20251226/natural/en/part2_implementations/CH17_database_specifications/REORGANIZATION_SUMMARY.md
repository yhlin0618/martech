# CH17 Database Specifications Reorganization Summary
...
Moved DB01-DB03 files from the main CH17 directory into the `duckdb/` subdirectory with appropriate DU prefixes:
...
- Updated main CH17 index.qmd to reference reorganized DuckDB structure
